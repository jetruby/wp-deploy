...
set :wp_email, "ilya.kuchaev@jetruby.com" # The admin email address
set :wp_sitename, "Cohenhandler" # The site title
...
set :repo_url, "git@github.com:jetruby/cohenhandler.git"
set :scm, :git
